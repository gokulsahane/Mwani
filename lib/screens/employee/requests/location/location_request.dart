...
class LocationRequest extends StatefulWidget {
  static const String routeName = '/location_request';
  const LocationRequest({Key? key}) : super(key: key);

  @override
  State<LocationRequest> createState() => _LocationRequestState();
}
            ...
            CustomButton(
              ...
              onTap: () {
                successDialog(
                  ...
                  message:
                      'Pre Overtime Approval request has been applied successfully & sent for HR approval.',
                );
              },
              curve: 100,
              height: 45,
