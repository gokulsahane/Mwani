...
class CashAdvanceRequest extends StatefulWidget {
  static const String routeName = '/cash_advance_request';
  const CashAdvanceRequest({Key? key}) : super(key: key);

  @override
  State<CashAdvanceRequest> createState() => _CashAdvanceRequestState();
}

class _CashAdvanceRequestState extends State<CashAdvanceRequest> {
  ///TEXT CONTROLLER
